...
void ElasticNormalImpactParticleWall02( const std::string input_filename, const std::string output_folder_name )
{
  int comm_rank = -1;
  ...
  // ====================================================
  particles->mesh_lo[0] = -40. * radius_p_inp;
  particles->mesh_lo[1] = -40. * radius_p_inp;
  particles->mesh_lo[2] = -4. * radius_p_inp;

  particles->mesh_hi[0] = 40. * radius_p_inp;
  particles->mesh_hi[1] = 40. * radius_p_inp;
...
int main( int argc, char* argv[] )
{
    ...
    ElasticNormalImpactParticleWall02( argv[1], argv[2] );
